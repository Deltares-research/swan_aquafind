...
# wind_dir_list = [270]
# offshore_wave_height_list = [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0]
...
wind_dir_list = [270]
offshore_wave_height_list = [0.5, 1.0, 1.5]
offshore_peak_period_list = [5.0, 7.5]
offshore_wave_dir_list = [270.0]
offshore_dspr_list = [20]  #!wat doen we hiermee?
bathy_list = ["constantBed"]
time_series_list_ww = ["A"]  # is not used in this case
...
################# swell
offshore_swell_wave_height_list = [0.5]
offshore_swell_peak_period_list = [15]
offshore_swell_wave_dir_list = [270.0, 315, 360, 45, 90]
offshore_swell_dspr_list = [10]  #!wat doen we hiermee?
...
# !! To do
# Djimin
# - Matlab; Bretschneider wind bepalen voor ww Hm0
# - Matlab; 2d spectra aanmaken
# - Matlab, twee verschillende sp2 bestanden per som, met ww en sw en alleen sw
# Menno
# - Python; Toevoegen 2d spectrum invoegen swan invoer
# - Python; SWAN invoer, meerdere boundaries gebruiken
# - Python; Extra SWAN uitvoerpunten toevoegen, 'invoer/dronepunten' aan de rand
# - Test som draaien
# remarks:
# nest boundary only one nc for all bc
# bekijken Azure sommen
...
for ii, item in enumerate(combinations):
    ...
    # if offshore_peak_period == 2.5 and offshore_wave_height > 1.0:
    #     print(
    #         "Skipping Tp={:2.2f} with Hm0={:2.2f}".format(
    #             offshore_peak_period, offshore_wave_height
    #         )
    #     )
    #     continue
    ...
    sim_name = "{}_u={:2.2f}Du={:03.0f}Hm0={:2.2f}Tp={:2.2f}Dw={:03.0f}Dspr={:2.0f}_HE10={:2.2f}_Tp2={:2.2f}_Dir2={:2.2f}_Dspr2={:2.2f}".format(
        bathy,
        wind,
